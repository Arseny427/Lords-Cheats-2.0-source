...
public class Button extends yea.bushroot.clickgui.component.Component {
	...
	public void renderComponent() {
		...
		FontUtils.normal.drawString(this.mod.getName(), (parent.getX() + 5), (parent.getY() + offset + 2), this.mod.isEnabled() ? ExampleMod.instance.settingsManager.getSettingByName("ClickGUI", "Rainbow").getValBoolean() ? ui.rainbow(300) : new Color(0x36D003).hashCode() : 0xFFFFFF); //0x999999
