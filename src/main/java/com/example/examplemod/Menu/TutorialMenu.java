...
public class TutorialMenu extends GuiScreen {
        ...
        if (button.id == 0) {
            ...
            try {
                ...
                if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
                    desktop.browse(new URI("https://www.youtube.com/channel/UCz3avodqwcaTtSV_MGFZuMQ"));
                }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawLogo.drawString(5, "TutorialClient", this.width / 10 - this.fontRenderer.getStringWidth("Lords Cheats") / 2,
