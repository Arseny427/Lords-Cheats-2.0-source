...
public class KillAura extends Module {
    ...
    public static boolean canSeeEntityAtFov(Entity entityIn, float scope) {
        double diffX = entityIn.posX - Minecraft.getMinecraft().player.posX;
        double diffZ = entityIn.posZ - Minecraft.getMinecraft().player.posZ;
    ...
    public static EntityLivingBase getSortEntities() {
        ...
        for (Entity e : Minecraft.getMinecraft().world.loadedEntityList) {
            if (e instanceof EntityLivingBase) {
                ...
                if (Minecraft.getMinecraft().player.getDistance(player) < range && (canAssist(player))) {
    ...
    public static boolean canAssist(EntityLivingBase player) {
        ...
        if (!player.canEntityBeSeen(Minecraft.getMinecraft().player)) {
            return walls;
        }
    ...
    public static float getGCD() {
        float f1;
        return (f1 = (float) (Minecraft.getMinecraft().gameSettings.mouseSensitivity * 0.6 + 0.2)) * f1 * f1 * 8;
    }
